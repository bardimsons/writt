...
files1=(
    ...
    "luci-app-argon-config|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/luci"
    "luci-theme-argon|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/luci"
    "luci-app-cpu-status-mini|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/luci"
    "luci-app-diskman|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/luci"
    "luci-app-disks-info|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/luci"
    "luci-app-log-viewer|https://fantastic-packages.github.io/packages/releases/23.05/packages/aarch64_generic/luci"
    "luci-app-temp-status|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/luci"
    "luci-app-internet-detector|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/luci"
    "internet-detector|https://fantastic-packages.github.io/packages/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/aarch64_generic/packages"
    "internet-detector-mod-modem-restart|https://fantastic-packages.github.io/packages/releases/23.05/packages/aarch64_generic/packages"
    ...
    "python3-speedtest-cli|https://downloads.openwrt.org/releases/-$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/$ARCH_3/packages"
    "librespeed-go|https://downloads.openwrt.org/releases/-$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/$ARCH_3/packages"
    "luci-app-ramfree|https://downloads.immortalwrt.org/snapshots/packages/$ARCH_3/luci"
    "luci-app-pbr|https://downloads.openwrt.org/releases/-$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/$ARCH_3/luci"
    "pbr|https://downloads.openwrt.org/releases/-$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/$ARCH_3/packages"
)
